({
    ...
    getOperatorListFromMap: function (datatype) {
        ...
        dataTypeOperatorsMap['MULTIPICKLIST'] = [{
        ...
        dataTypeOperatorsMap['REFERENCE'] = [{
                'label': 'Does not equal',
                'value': 'not_equals'
            },
            {
